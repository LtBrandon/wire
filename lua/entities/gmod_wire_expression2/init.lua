...
local wire_expression2_unlimited = CreateConVar("wire_expression2_unlimited", "0", FCVAR_NOTIFY)
local wire_expression2_quotasoft = CreateConVar("wire_expression2_quotasoft", "10000", FCVAR_NOTIFY)
local wire_expression2_quotahard = CreateConVar("wire_expression2_quotahard", "100000", FCVAR_NOTIFY)
local wire_expression2_quotatick = CreateConVar("wire_expression2_quotatick", "25000", FCVAR_NOTIFY)
